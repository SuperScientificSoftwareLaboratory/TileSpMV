                  ...
                  VALUE_TYPE *x, VALUE_TYPE *y, VALUE_TYPE alpha)
{
    ...
    cout << "CSR->CSR5 time = " << csr2csr5 << " ms." << endl;
    ...
    // fprintf(fout, "%s,%s,%i,%i,%i,%f,%f,%f,%f\n", 
    //         sizeof(VALUE_TYPE) == 8 ? "DOUBLE" : "FLOAT", 
    //         filename, m, n, nnzA, csr2csr5, CSR5Spmv_time, gb/(1.0e+6 * CSR5Spmv_time), gflop/(1.0e+6 * CSR5Spmv_time));
    // fclose(fout);
